...
public class ProductService {
	...
	public Product getProductByAlias(String alias) throws ProductNotFountException {
		Product product= repo.findByAlias(alias);
		if(product == null) {
			throw new ProductNotFountException("could not find any product with alias "+ alias);
		}
		return product;
	}
	...
	public Product getProductByID(int id) throws ProductNotFountException {
